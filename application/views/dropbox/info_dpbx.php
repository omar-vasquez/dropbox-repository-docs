  ...
  <div class="col-md-12">
   <div class="panel panel-default">
    <div class="panel-body">
      <div class="row">
        <div class="col-md-6">
          <h3>Documento test</h3>
          <h3><small>Doc. Documento-test.txt</small></h3>
          ...
          <p><strong>Ultima modificacion:</strong>
    ...
    <div class="panel-footer">
          <div class="row">
            <div class="col-md-6">
              <p>
              <small> fecha de ultima modificacion: juev diciembre 22134324 de </small>
              </p>
            </div>
            <div class="col-md-6 text-right">
              <button type="" class="btn btn-default btn-sm">actualizar</button>
              <button type="" class="btn btn-default btn-sm">Descargar</button>
              <button type="" class="btn btn-default btn-sm">Historial</button>
            </div>
          </div>
    </div>
  </div>
